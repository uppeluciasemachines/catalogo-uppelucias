...
export function CartSidebar() {
  ...
  return (
    <>
      ...
      ============================================ */}
      <aside className="fixed right-0 top-0 h-full w-full max-w-md bg-card z-50 animate-slide-in-right flex flex-col">
        {/* ============================================
        ...
        <div className="flex-1 overflow-y-auto p-4">
          {cart.length === 0 ? (
            ...
            <div className="flex flex-col items-center justify-center h-full text-muted-foreground">
              ...
              <p className="text-sm mt-2">Adicione pelúcias para continuar</p>
            </div>
          ) : (
            /* Lista de produtos */
        ...
        {cart.length > 0 && (
          <div className="border-t border-border p-4 space-y-4">
            ...
            <button
              ...
              className="w-full bg-whatsapp hover:bg-whatsapp/90 text-whatsapp-foreground font-bold py-4 px-6 rounded-lg flex items-center justify-center gap-3 transition-colors"
            >
            ...
            <button
              onClick={clearCart}
              className="w-full text-muted-foreground hover:text-foreground py-2 transition-colors text-sm"
            >
              Limpar carrinho
            </button>
          </div>
